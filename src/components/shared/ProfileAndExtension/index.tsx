...
import { setExtChange } from "redux/common/commonSlice";
							...
							<circle
								...
								fill={
									status.main_status == "available"
										? "#75C322"
										: status.main_status == "do_not_disturb"
										? "rgb(238, 57, 57)"
										: "#91A0B5"
								}
								stroke="white"
			...
			{isExtensionOpen && (
				<div>
					<div
						...
						onClick={() => {
							store.dispatch({ type: "sip/isProfileOpen", payload: false });
						}}></div>
