...
interface IVoicemailIcon {
	tabActive: string;
	tabHovered: string;
}

const VoicemailIcon: React.FC<IVoicemailIcon> = ({ tabActive, tabHovered }) => (
	<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
		<g id="line / voicemail" clipPath="url(#clip0_2129_3092)">
			<path
				...
				stroke={tabActive === "7" || tabHovered === "7" ? "var(--text-link, #1480e1)" : "var(--text-primary, #1f2023)"}
				strokeWidth="1.5"
				strokeLinecap="round"
			/>
		</g>
