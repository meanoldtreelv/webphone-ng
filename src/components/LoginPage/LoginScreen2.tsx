		...
		<section className={classes.login}>
			...
			<div className={classes.login_textBox}>
				<div className={classes.login_text}>
					<h1 className={`title_2_bold ${classes.login_join}`}>Join the RingPlan Team</h1>
					<p className={`body ${classes.login_doMore}`}>Do more with Ringplan.</p>
					<div className={`body ${classes.login_continueRingplan}`} onClick={onContinueWithRingplan}>
						<img src="/icon/ri.svg" alt="" />
						<span>Continue with Ringplan</span>
					</div>

					<p className={`caption_1 ${classes.login_withExtension}`}>Or login with extension and secret</p>
					...
					<div className={`caption_1  ${classes.login_inputBox}`}>
						<input type="text" placeholder="Enter server address here..." required />
						<p className={`caption_2 ${classes.login_inputBox_error}`}>Error</p>
					...
					<div className={`caption_1 ${classes.login_inputBox}`}>
						<input type="text" placeholder="Enter secret code here..." required />
						<p className={`caption_2 ${classes.login_inputBox_error}`}>Error</p>
						<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
							<g id="line / lock">
								<path
