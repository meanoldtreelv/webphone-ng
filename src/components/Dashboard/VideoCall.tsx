      ...
      <div className={classes.videoCall_video}>
        ...
        <div className={`${classes.videoCall_descriptionBox}`}>
          ...
          <div className={`flex gap-4 items-center`}>
            <p
              className={`body ${classes.videoCall_timer}`}
              style={{ color: " var(--text-primary, #1F2023)" }}
            >
              03:45
            </p>
      ...
      <div>
        <div className={classes.videoCall_box}>
          <div className={classes.videoCall_actionBox}>
            ...
            <div className={`${classes.videoCall_action} `}>
              <span
                className={`${classes.videoCall_icon} ${classes.videoCall_endButton}`}
              >
                <svg
                  width="36"
                  height="36"
                ...
                >
                  <g id="fill / call_pause">
                    <g id="Vector">
                      ...
                      />
                      <path
                        d="M20 2.6665H22.6666V13.3332H20V2.6665Z"
                        fill="#191C1F"
                      />
                      <path
                        d="M29.3333 2.6665H26.6666V13.3332H29.3333V2.6665Z"
                        fill="#191C1F"
                      />
                    </g>
                  </g>
