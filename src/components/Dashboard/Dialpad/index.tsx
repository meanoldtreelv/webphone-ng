	...
	return (
		<section className={styles.dialpad}>
			<div className={styles.dialpad_number}>
				<input type="text" placeholder="Enter number" onChange={(e) => {dispatch(setCallNumber(e.target.value = e.target.value.replace(/[^\d#+*]+/g, "") ))} } className={styles.numberEntered} value={number} />
			</div>
