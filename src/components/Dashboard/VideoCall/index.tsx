			...
			<div className={styles.videoCall_video}>
				...
				<div className={`${styles.videoCall_descriptionBox}`}>
					...
					<div className={`flex gap-4 items-center`}>
						<p className={`body ${styles.videoCall_timer}`} style={{ color: " var(--text-primary, #1F2023)" }}>
							03:45
						</p>
			...
			<div>
				<div className={styles.videoCall_box}>
					<div className={styles.videoCall_actionBox}>
						...
						<div className={styles.videoCall_action}>
							<span className={styles.videoCall_icon}>
              ...
              >
                Transfer
						...
						<div className={`${styles.videoCall_action} `}>
							<span className={`${styles.videoCall_icon} ${styles.videoCall_endButton}`}>
						...
						<div className={styles.videoCall_action}>
							<span
								className={styles.videoCall_icon}
								style={
									isVideoCallActive
										? isVideoPause
