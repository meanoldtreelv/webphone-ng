...
const ProfileMenu = () => {
	return (
		<div className={classes.profile}>
			<div className={classes.profile_nameBox}>
				<span className={`sub_headline ${classes.profile_image}`}>VS</span>{" "}
				<span className={`body_bold ${classes.profile_name}`}>Valentyn S.</span>
			</div>
			<div className={classes.profile_settingBox}>
				<div className={classes.profile_settingBox_item}>
			...
			<div className={classes.profile_logout}>
				<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
					<g id="line / sign_out">
						<path
							id="Vector"
