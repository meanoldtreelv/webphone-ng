	...
	return (
		<div className={classes.profileMenu}>
			<div className={classes.profileBox}>
				...
				<p className={`footnote ${classes.heading}`}>Status</p>
				<div className={`body ${classes.status}`}>
					<div className={`${classes.status_type}`}>
						<span>
							<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
								<g id="user_status">
				...
				<p className={`footnote ${classes.heading}`}>Additional Status</p>
				<div className={`body ${classes.status}`}>
					<div className={`${classes.status_type}`}>
						<span>
							...
							<span className={`${classes.status_type_active}`}>On a call</span>
						</span>
					</div>
					<div className={`${classes.status_type}`}>
						<span>
							...
							<span className={`${classes.status_type_active}`}>In a meeting</span>
						</span>
					</div>
					<div className={`${classes.status_type}`}>
						<span>
							...
							<span className={`${classes.status_type_active}`}>Lunch</span>
						</span>
						<span>
							<span>DND :</span>
						</span>
					...
					<div className={`${classes.status_type}`}>
						<span>
							...
							<span className={`${classes.status_type_active}`}>Holiday</span>
						</span>
						<span>
							<span>DND :</span>
						</span>
					...
					<div className={`${classes.status_type}`}>
						<span>
							...
							<span className={`${classes.status_type_active}`}>AFK</span>
						</span>
					</div>
				</div>
				<div className={classes.clearStatus}>Clear Status</div>
			</div>
		</div>
	);
};
