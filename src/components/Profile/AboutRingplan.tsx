...
import classes from "./aboutRingplan.module.scss";

const AboutRingplan = () => {
  return (
    <div className={classes.aboutRingplan}>
      <div className={classes.aboutBox}>
        ...
        <div className={`body flex flex-col gap-2 ${classes.updateBox}`}>
          <div
            className={`flex justify-between items-center px-2 py-4 cursor-pointer`}
          >
