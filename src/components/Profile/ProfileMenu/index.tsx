		...
		<div className={styles.profile}>
			<div className={styles.profile_nameBox}>
				<span className={styles.profile_image}>
					{(apiAuth && nameIcon(apiAuth["displayname"])) || (extNumber && extNumber[0])}
				</span>
			...
			<div className={styles.profile_settingBox}>
				...
				<div
					className={styles.profile_settingBox_item}
					onClick={() => {
						store.dispatch({ type: "sip/aboutRingplan", payload: true });
					}}>
					<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<div
				...
				onClick={() => {
					store.dispatch({ type: "sip/logoutPopUp", payload: true });
				}}>
				<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
					<g id="line / sign_out">
						<path
