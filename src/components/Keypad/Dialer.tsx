  ...
  return (
    <section className={classes.dialer}>
      <div className={classes.dialer_details}>
        <div className={`large_title ${classes.dialer_profile}`}>MW</div>
        <p
          className={`title_1`}
        ...
        <div
          className={`bold ${classes.dialer_timer}`}
          style={{ color: "var(--text-primary, #1F2023)" }}
        >
          03:45
        </div>
      ...
      <div className={classes.dialer_box}>
        <div className={classes.dialer_actionBox}>
          <div className={classes.dialer_action}>
            <span className={classes.dialer_icon}>
              <svg
                width="32"
                height="32"
                viewBox="0 0 32 32"
            ...
            <p
              className={`caption_2 ${classes.dialer_text}`}
              style={{ color: "var(--text-primary, #1F2023)" }}
            >
              Add Call
            </p>
        ...
        <div className={classes.dialer_actionBox}>
          ...
          <div
            className={`${classes.dialer_control} ${classes.dialer_endButton}`}
          >
            <svg
              width="36"
              height="36"
